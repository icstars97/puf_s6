...
create_project -name puf -dir "I:/FPGA_projects/puf/xise_prj/planAhead_run_2" -part xc6slx9tqg144-2
...
link_design
read_xdl -file "I:/FPGA_projects/puf/xise_prj/toplevel.ncd"
if {[catch {read_twx -name results_1 -file "I:/FPGA_projects/puf/xise_prj/toplevel.twx"} eInfo]} {
   puts "WARNING: there was a problem importing \"I:/FPGA_projects/puf/xise_prj/toplevel.twx\": $eInfo"
}
